...
CREATE TABLE `tbl_prestamo` (
  ...
  `pres_hora` time NOT NULL,
  `pres_valor` int(20) DEFAULT NULL,
  `pres_int_id` int(11) DEFAULT NULL,
  `pres_soc_id` int(11) DEFAULT NULL,
  `pres_est_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`pres_id`),
  KEY `pres_int_id_idx` (`pres_int_id`),
  KEY `pres_soc_id_idx` (`pres_soc_id`),
  KEY `pres_est_pres_id_idx` (`pres_est_id`)
