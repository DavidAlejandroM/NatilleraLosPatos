...
CREATE TABLE `tbl_tipo_ingreso` (
  `tip_ing_id` int(11) NOT NULL AUTO_INCREMENT,
  `tip_ing_nombre` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`tip_ing_id`)
...
INSERT INTO `tbl_tipo_ingreso` VALUES (1,'Mensualidad'),(2,'Comida'),(3,'Juegos'),(4,'Interes'),(5,'Deuda'),(6,'Interes-Deuda');
